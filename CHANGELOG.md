...
- ACF Pro and other plugins that use WP admin pages for custom functionality were being blocked
...
### Fixed
- Fixed blocking of WP Pages and Custom Post Types when editing
